...
Mobile.setText(findTestObject('Object Repository/Login1Folder/android.widget.LoginText'), 'testlogicielprojet@gmail.com', 0)

Mobile.tap(findTestObject('Object Repository/Login1Folder/android.widget.Button - show password'), 0)

Mobile.setText(findTestObject('Object Repository/Login1Folder/android.widget.Password'), '123456', 0)
